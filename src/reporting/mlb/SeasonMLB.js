...
class SeasonMLB extends Component {
  constructor(props) {
    super(props);
   ...
   render() {
     ...
     return (
       ...
       <View style={{flex:1, flexDirection:'column', backgroundColor:'whitesmoke'}}>
        <View style={{flex:.2, height:80, paddingTop:65, alignItems:'center', borderBottomWidth:2, borderColor:'black', backgroundColor:'ghostwhite'}}>
          <Text style={{fontSize:40, fontFamily:'cochin'}}>Season 2017</Text>
        </View>
        <View style={{flex:.8, flexDirection:'column', alignItems:'center', }}>
          <View style={styles.seasonRow}>
            ...
            <View style={styles.seasonBox}>
              <Text style={styles.seasonTextLabel}>Wins</Text>
              <Text style={styles.seasonTextContent}>{this.state.seasonStats[0][0]['count(win)']}</Text>
            </View>
            <View style={styles.seasonBox}>
              <Text style={styles.seasonTextLabel}>Losses</Text>
          ...
          <View style={styles.seasonRow}>
            <View style={styles.seasonBox}>
              <Text style={styles.seasonTextLabel}>Avg CLV</Text>
          ...
          <View style={styles.seasonRow}>
          <View style={styles.seasonBox}>
            <Text style={styles.seasonTextLabel}>Avg Bet</Text>
            <Text style={styles.seasonTextContent}>{avgLineCleaned}</Text>
          </View>
            <View style={styles.seasonBox}>
              <Text style={styles.seasonTextLabel}>Favorites</Text>
