...
class YesterdayMLB extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
   ...
   fetchData() {
     var fetchString = 'http://linkapp.mywire.org:3000/reporting/mlb/yesterday';
     fetch(fetchString)
     ...
     .then((responseData) => {
       ...
       sectionIDs.push("Games");

       dataBlob["Overall"] = "Overall";
       dataBlob["Games"] = "Games";
       ...
       for(i = 0; i < len; i++) {
        ...
        rowIDs[1].push(wager.ticket);
        dataBlob['Games:' + wager.ticket] = wager;
  ...
  render() {
    var today = new Date();
    var yesterday = new Date(today - 3600000*28);
    var dayString = days[yesterday.getDay()];
    return(
      <View style={{flex:1, flexDirection:'column'}}>
        <View style={{height:90, alignItems:'center', paddingTop:35, backgroundColor:'snow'}}>
