...
class PlayerWebView extends Component {
  ...
  render() {
    return(
        ...
        <WebView
          source={{uri: 'http://www.fangraphs.com/statss.aspx?playerid=' + String(this.props.player_id)}}
          style={{marginTop: 0}}
...
export default class DisplayBullpenStats extends Component {
  constructor(props) {
    super(props);
  ...
  this.props.nav.push({
    title:this.props.player.split(" (")[0],
    component:PlayerWebView,
    passProps:{player_id : String(this.props.currentData.player_id)}
      ...
      return (
        <View style={{flex:1, flexDirection:'column', alignItems:'center'}}>
          ...
          <View style={{height:0, width:0}}>
            <WebView
              source={{uri: 'http://www.fangraphs.com/statss.aspx?playerid=' + String(c.player_id)}}
            />
          </View>
